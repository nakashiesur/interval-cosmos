...
const tests=[
  ['MY COSMOS polish stylesheet is loaded',index.includes('phase10-cosmos-polish-v205.css?v=alpha10.3')],
  ['MY COSMOS polish is cached',sw.includes('phase10-cosmos-polish-v205.css')&&sw.includes('alpha10-62')],
  ...
  ['very narrow phones leave room for the full player ID',css.includes('grid-template-columns:58px minmax(0,1fr)')&&css.includes('grid-row:2')&&css.includes('padding-right:46px')],
