...
const context = {
  ...
  caches: {
    ...
    keys: async () => ['unrelated-app', 'interval-cosmos-old', 'interval-cosmos-v2-0-5-alpha10-24'],
...
(async () => {
  ...
  assert.deepEqual(deleted, ['interval-cosmos-old', 'interval-cosmos-v2-0-5-alpha10-24']);
