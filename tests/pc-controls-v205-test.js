...
const tests=[
  ...
  ['learning state uses red pulse and Japanese waiting copy',polishCss.includes('@keyframes v205PcLearn') && polishJs.includes('希望するキーを押してください。') && polishJs.includes("recording.textContent = '入力待ち…'")],
  ...
  ['polish assets are loaded',index.includes('phase8-config-polish-v205.css?v=alpha8.6') && index.includes('phase8-config-polish-v205.js?v=alpha8.6')],
  ['pc assets use new cache version',sw.includes('alpha8-6')],
