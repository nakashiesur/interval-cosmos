...
const tests=[
  ...
  ['REC capture and reset/save exist',js.includes('data-pc-record') && js.includes('data-pc-config-reset') && js.includes('data-pc-config-save')],
  ...
  ['pc assets use new cache version',index.includes('phase8-pc-controls-v205.css?v=alpha8.3') && sw.includes('alpha8-3')],
  ['pc assets cached',sw.includes('phase8-pc-controls-v205.js') && sw.includes('phase8-pc-controls-v205.css')],
