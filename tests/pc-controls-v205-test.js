...
const tests=[
  ...
  ['polish assets are loaded',index.includes('phase8-config-polish-v205.css?v=alpha8.5') && index.includes('phase8-config-polish-v205.js?v=alpha8.5')],
  ['pc assets use new cache version',sw.includes('alpha8-5')],
