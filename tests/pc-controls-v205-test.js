...
const tests=[
  ...
  ['PC controls load before assignment engine',index.indexOf('phase8-pc-controls-v205.js?v=alpha8.7') < index.indexOf('phase6-assignments-v205.js?v=alpha5.7')],
  ...
  ['pc assets use current cache generation',sw.includes('alpha10-25')],
