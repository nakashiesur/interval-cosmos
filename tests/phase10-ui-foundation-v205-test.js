...
const tests=[
  ...
  ['Phase 10 header polish is loaded and cached',index.includes('phase10-header-polish-v205.css?v=alpha10.10')&&sw.includes('phase10-header-polish-v205.css')&&sw.includes('alpha10-38')],
