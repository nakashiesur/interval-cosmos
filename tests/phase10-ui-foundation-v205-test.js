...
const tests=[
  ['Phase 10 foundation assets are loaded',index.includes('phase10-ui-foundation-v205.js?v=alpha10.8')&&index.includes('phase10-ui-foundation-v205.css')],
  ['Phase 10 header polish is loaded and cached',index.includes('phase10-header-polish-v205.css?v=alpha10.10')&&sw.includes('phase10-header-polish-v205.css')&&sw.includes('alpha10-48')],
  ...
  ['desktop action cluster has an explicit in-panel width budget',headerCss.includes('grid-template-columns:140px 130px 44px')&&headerCss.includes('width:326px')&&headerCss.includes('justify-self:end')],
  ['narrow desktop compacts before the mobile breakpoint',headerCss.includes('@media (min-width:701px) and (max-width:1050px)')&&headerCss.includes('grid-template-columns:126px 118px 42px')&&headerCss.includes('width:296px')&&headerCss.includes('font-size:28px')],
  ...
  ['runtime fallback compacts the desktop header when geometry still overlaps',js.includes("classList.add('v205-header-auto-tight')")&&headerCss.includes('.topbar-home.v205-header-auto-tight')&&headerCss.includes('width:266px!important')],
  ['desktop gear cannot grow beyond its reserved track',headerCss.includes('min-width:44px!important')&&headerCss.includes('width:44px!important')&&headerCss.includes('padding:0!important')],
