...
const js = fs.readFileSync(path.join(__dirname,'..','phase2-recovery-v205-fixed.js'),'utf8');
...
const assertions = [
  ...
  ['recovery assets loaded', index.includes('phase2-recovery-v205-fixed.js?v=alpha4.2.3') && index.includes('phase2-recovery-v205.css?v=alpha4.2.1')],
